                ...
                l(a.LIGHTBOX_SELECTOR + " " + a.GALLERY_ITEM_SELECTOR).on(
                    ...
                    function (t) {
                        ...
                        if (!image.is("[data-href]")) {
                            ...
                            var index = l(t.currentTarget).attr(
                                "data-pswp-item-id"
                            );
                            if (index >= 0)
                                this.openOnClick(
            ...
            return function (template, t, items, e) {
                ...
                var l = function () {
                    ...
                    ni = function (t) {
                        ...
                        if (0 === f)
                            if (
                                ((le = false), i.unbind(window, w, n), Pe(), ye)
                            )
                                c = 0;
            ...
            !(function (e, i, n) {
                ...
                var tt = function () {
                    ...
                    nt = function () {
                        ...
                        for (
                            Mt = l.max(Mt, bt()), p = 0, h = Lt.length;
                            p < h;
                            p++
                        ) {
                            for (
                ...
                a.setStyle = function (el, t, e) {
                    ...
                    if (
                        ...
                        try {
                            if (X)
                                style[
                                    X + t.slice(0, 1).toUpperCase() + t.slice(1)
                                ] = e;
                            style[t] = e;
                        } catch (t) {}
                };
