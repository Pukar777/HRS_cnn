...
@section('content-1')
    ...
    <section class="form__login u-clearfix u-image u-section-1" src="" id="sec-ff7e" data-image-width="1280"
                        ...
                        <div class="u-align-center u-container-style u-layout-cell u-size-30 u-white u-layout-cell-2">
                            <div class="u-container-layout u-container-layout-2">
                                <div class="u-form u-form-1">
                                    <form id="authSignup" action="{{ route('auth.register') }}" method="POST"
                                        class="u-clearfix u-form-spacing-27 u-form-vertical u-inner-form"
                                        style="padding: 0px;" source="custom" name="form">
                                        @csrf
                                        <div class="u-form-group u-form-name u-form-group-1">
                                            <label for="name" class="u-form-control-hidden u-label"
                                                wfd-invisible="true">Name</label>
                                            <input value="{{ old('email') }}" type="text" placeholder="Email" id="email"
                                                name="email"
                                        ...
                                        <div class="u-form-group u-form-group-2">
                                            ...
                                            <input value="{{ old('name') }}" type="text" placeholder="Username" id="name"
                                                name="name"
                                        ...
                                        <div class="u-form-group u-form-group-3">
                                            <label for="password" class="u-form-control-hidden u-label"
                                                wfd-invisible="true"></label>
                                            <input type="password" id="password" name="password"
                                                class="u-border-2 u-border-grey-5 u-grey-5 u-input u-input-rectangle u-radius-50 u-input-3"
                                        ...
                                        <div class="u-form-group u-form-group-4">
                                            ...
                                            <input type="password" placeholder="Confirm password" id="confirm_password"
                                                ...
                                                class="u-border-2 u-border-grey-5 u-grey-5 u-input u-input-rectangle u-radius-50 u-input-4"
                                                required="required">
                                        </div>

                                        <div class="u-align-left u-form-group u-form-submit u-form-group-5">
                                            <a onclick="document.getElementById('authSignup').submit()"
                                                class="u-active-grey-75 u-border-1 u-border-active-grey-75 u-border-hover-black u-border-palette-2-base u-btn u-btn-round u-btn-submit u-button-style u-hover-black u-palette-2-light-1 u-radius-50 u-btn-1">Sign
                                                up</a>
                                        </div>
                                    </form>
                                </div>
                                <p class="u-text u-text-custom-color-5 u-text-default u-text-1">Forgot Password?</p>
                                <p class="u-text u-text-default u-text-2">Already a member?&nbsp;<a href="#/signup"
