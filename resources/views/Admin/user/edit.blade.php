            ...
            <div class="col-md-10">
                <div class="card">            
                    ...
                    <div class="card-body g-3" id="create_form">
                        ...
                        {{ Form::open(array('url' => route('admin.user_manage.update', $user->id), 'method'=>"PUT")) }}

                            <div class="">
                                {{  Form::text('name', $user->name, ['id'=>'name', 'placeholder'=>'Username', 'required'=>'', 'class'=>'form-control'])  }}
                            </div>
                            <br>
                            <div class="">
                                {{  Form::text('email', $user->email, ['id'=>'email', 'placeholder'=>'Email', 'required'=>'', 'class'=>'form-control'])  }}
                            </div>
                            <br>
                            <div class="">
                                {!! Form::select('roles[]', $roles, $user->role, ['class'=> 'form-control selectpicker', 'multiple'=>'', 'data-live-search'=>'true']) !!}
                            </div>
                            <br>
